...
const ProcessOptimization = () => {
  const weeklyBreakdown = [
    { 
      week: 1, 
      title: "Masterclass – Process Optimization Fundamentals", 
      hours: 22, 
      description: "Expert session on process mapping, optimization frameworks, AI integration, governance integration, and change management.", 
      activities: [
        "Learn to map current state processes and identify inefficiencies",
        "Understand frameworks for process improvement (Lean, Six Sigma, BPM)",
        "Plan for integrating AI capabilities into optimized processes",
        "Design governance and oversight into optimized processes",
        "Plan for process change and adoption"
      ] 
    },
    { 
      week: 2, 
      title: "Hands-On Labs – Process Redesign", 
      hours: 30, 
      description: "Practical exercises in current state analysis, future state design, and governance design.", 
      activities: [
        "Map current state processes",
        "Identify inefficiencies and improvement opportunities",
        "Create process maps and analysis reports",
        "Design optimized future state processes",
        "Integrate AI capabilities into process design",
        "Design governance and oversight into optimized processes",
        "Plan control points and approval workflows"
      ] 
    },
    { 
      week: 3, 
      title: "Mentored Sessions – Process Refinement", 
      hours: 22, 
      description: "Expert guidance on process designs, best practices, change management, and governance planning.", 
      activities: [
        "Get guidance on your process designs",
        "Learn from successful process optimization implementations",
        "Discuss strategies for process change adoption",
        "Analyze real-world process optimization scenarios",
        "Plan for maintaining governance in optimized processes"
      ] 
    },
    { 
      week: 4, 
      title: "Mini-Capstone – Optimized Process Design", 
      hours: 30, 
      description: "Design a complete optimized process with AI integration including current state analysis, optimization opportunities, future state design, governance framework, change plan, and success metrics.", 
      activities: [
        "Complete mapping and analysis of current process",
        "Identified improvements and AI integration points",
        "Detailed design of optimized process with AI capabilities",
        "Governance and oversight design for optimized process",
        "Strategy for implementing process changes",
  ...
  const learningOutcomes = [
    "Create comprehensive current state process maps",
    "Find optimization and AI integration opportunities",
    "Create future state process designs with AI integration",
    "Design governance and oversight into optimized processes",
    "Create strategies for process change implementation",
    "Define metrics for measuring process improvement"
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Master AI process optimization in this 90-hour module. Learn to streamline AI-driven processes, redesign workflows, and integrate AI capabilities while maintaining governance." />
      </Helmet>
      <Header />
        ...
        <section className="bg-navy text-primary-foreground py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container-coad relative z-10">
            <div className="max-w-4xl">
              ...
              <p className="body-large text-gray-300 mb-8 max-w-2xl">Streamline AI-driven processes and redesign workflows for optimal efficiency. Learn to map current processes, identify optimization opportunities, design improved workflows, and integrate AI capabilities while maintaining governance and oversight.</p>
