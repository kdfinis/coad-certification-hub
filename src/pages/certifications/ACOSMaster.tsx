...
const ACOSMaster = () => {
  const modules = [
    {
      ...
      duration: "4 weeks",
      topics: [
        "Strategic governance framework design",
    ...
    {
      number: "02",
      title: "Board-level Advisory & Reporting",
      duration: "4 weeks",
      topics: [
  ...
  const outcomes = [
    "Design and implement enterprise-wide AI governance strategies",
    "Advise boards and executive committees on AI governance matters",
    "Navigate complex multi-jurisdictional compliance requirements",
    "Lead responsible AI initiatives at organisational level",
    "Shape AI ethics policies and culture",
    "Drive strategic AI governance decisions at board level",
    "Represent organisations to regulatory authorities",
    "Mentor and develop the next generation of AI oversight professionals"
  ];
  ...
  const whoIsThisFor = [
    {
      ...
      description: "Executives leading enterprise-wide AI governance programmes"
    },
    {
      icon: BalanceScaleIcon,
      title: "General Counsel",
      description: "Legal leaders responsible for AI regulatory strategy"
    },
    {
      icon: NeuralBrainIcon,
      title: "Chief Ethics Officers",
      description: "Executives championing responsible AI at organisational level"
    },
    {
      icon: ShieldNodeIcon,
      title: "Senior Consultants",
      description: "Advisory professionals offering AI governance services"
    }
  ];
  ...
  const charterholderBenefits = [
    {
      ...
      description: "The highest recognition in AI oversight, demonstrating mastery of the field"
    },
    {
  ...
  const assessments = [
    {
      ...
      description: "Complete enterprise governance strategy deliverable",
      weight: "35%"
    },
    {
      type: "Board Advisory Simulation",
      description: "Executive presentation and Q&A scenarios",
      weight: "25%"
    },
    {
      type: "Oral Defence",
      description: "Panel defence of governance strategy and approach",
      weight: "20%"
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>ACOS Master Charterholder | The Pinnacle of AI Oversight | COAD</title>
        <meta name="description" content="Achieve the highest recognition in AI oversight with the ACOS Master Charterholder certification. Lead enterprise governance strategy and board-level AI advisory." />
      </Helmet>
      ...
      <main className="pt-20">
          ...
          <div className="container-coad relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="heading-1 mb-6">
                ACOS Master <span className="gradient-text">Charterholder</span>
              </h1>
              
              <p className="body-large text-gray-300 mb-8 max-w-2xl">
                The pinnacle of AI oversight expertise. Master Charterholders are recognised 
                authorities who shape enterprise governance strategy and advise at board level 
                across Europe.
              </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
              ...
              <div>
                ...
                <p className="text-muted-foreground max-w-xl">
                  ...
                  achievement in AI oversight and governance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container-coad">
            <div className="text-center mb-12">
              ...
              <p className="body-large text-muted-foreground max-w-2xl mx-auto">
                The ACOS Master Charterholder programme is designed for senior leaders 
        ...
        <section className="section-padding bg-muted/50">
          <div className="container-coad">
            <div className="text-center mb-12">
              ...
              <p className="body-large text-muted-foreground max-w-2xl mx-auto">
                Four comprehensive modules developing mastery in enterprise AI oversight.
              </p>
            </div>
        ...
        <section className="section-padding bg-background">
          <div className="container-coad">
            <div className="text-center mb-12">
              <h2 className="heading-2 mb-4">Your ACOS Journey to Charterholder</h2>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-primary/10 to-teal/10 rounded-2xl p-8 border-2 border-primary text-center">
                ...
                <h3 className="heading-3 mb-4">ACOS Charterholder Status</h3>
                <p className="body-large text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Upon completing all 4 domains at Master level, you achieve ACOS Charterholder status—the highest recognition in AI oversight. Charterholders receive priority placement in the Accredited Experts Directory, exclusive community access, and speaking opportunities.
                </p>
                <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-6">
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <div className="font-semibold mb-2">Priority Directory Placement</div>
                    <p className="text-sm text-muted-foreground">Charterholder badge and top search results</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <div className="font-semibold mb-2">Exclusive Community</div>
                    <p className="text-sm text-muted-foreground">Access to Charterholder peer network</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <div className="font-semibold mb-2">Speaking Opportunities</div>
                    <p className="text-sm text-muted-foreground">Invitations to COAD events and conferences</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <div className="font-semibold mb-2">Advisory Referrals</div>
                    <p className="text-sm text-muted-foreground">Consulting and advisory opportunities</p>
                  </div>
                </div>
                <Button variant="hero" size="lg" asChild>
                  <Link to="/certifications">Complete All Domains</Link>
                </Button>
              </div>
            </div>
          </div>
        ...
        <section className="section-padding bg-muted/50">
          <div className="container-coad">
            <div className="text-center mb-12">
              ...
              <p className="body-large text-muted-foreground max-w-2xl mx-auto">
                Upon achieving the ACOS Master Charterholder designation, you will be able to:
              </p>
            </div>
          ...
          <div className="container-coad">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="body-large text-muted-foreground mb-8">
                Join the elite community of AI oversight authorities in Europe.
              </p>
