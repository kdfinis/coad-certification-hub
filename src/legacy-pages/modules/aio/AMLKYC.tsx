...
import { NeuralBrainIcon, CheckNodeIcon, ClockNodeIcon, AwardNodeIcon, GraduationNodeIcon } from '@/components/ui/custom-icons';
...
const AMLKYC = () => {
  ...
  const realWorldUseCases = [
    { industry: "Retail Banking", scenario: "Implementing AI-powered transaction monitoring for mass-market customer accounts." },
    { industry: "Investment Banking", scenario: "Enhanced due diligence AI for complex corporate structures and PEP screening." },
    { industry: "Cryptocurrency", scenario: "AI compliance tools for blockchain analytics and travel rule compliance." },
          ...
          <div className="container-coad">
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                ...
                <p className="body-large text-muted-foreground mb-6">AI is transforming financial compliance. This intensive module teaches you to implement, validate, and govern AI systems in AML/KYC processes.</p>
                <p className="body text-muted-foreground mb-8">You'll learn to deploy AI-powered transaction monitoring, automate customer due diligence, and prepare for regulatory examinations of AI compliance systems.</p>
                <div className="bg-muted/50 rounded-xl p-6 border border-border">
                  <h3 className="font-semibold mb-4">Assessment Criteria</h3>
                  <ul className="space-y-3">
                    {["Project rubric assessment (80% pass threshold)", "Compliance AI framework delivery", "Validation methodology", "Regulatory documentation"].map((item, i) => (
