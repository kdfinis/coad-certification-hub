...
import { DataFlowIcon, CheckNodeIcon, ClockNodeIcon, AwardNodeIcon, GraduationNodeIcon } from '@/components/ui/custom-icons';
...
const ResourceManagement = () => {
  ...
  const realWorldUseCases = [
    { industry: "Enterprise IT", scenario: "Balancing AI infrastructure investments across cloud, on-premise, and edge deployment requirements." },
    { industry: "Consulting", scenario: "Allocating AI talent and resources across multiple client engagements effectively." },
    { industry: "Manufacturing", scenario: "Planning AI resources for Industry 4.0 transformation across production facilities." },
          ...
          <div className="container-coad">
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                ...
                <p className="body-large text-muted-foreground mb-6">AI success requires more than technology – it requires smart resource allocation. This module teaches strategic planning for AI investments.</p>
                <p className="body text-muted-foreground mb-8">You'll learn to balance competing priorities, optimize budgets, and build teams that deliver AI value while meeting compliance requirements.</p>
                <div className="bg-muted/50 rounded-xl p-6 border border-border">
                  <h3 className="font-semibold mb-4">Assessment Criteria</h3>
                  <ul className="space-y-3">
                    {["Project rubric assessment (80% pass threshold)", "Resource strategy delivery", "Budget projections", "Implementation roadmap"].map((item, i) => (
